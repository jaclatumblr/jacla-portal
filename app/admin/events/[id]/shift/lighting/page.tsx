...
const slotTypeLabel = (slot: EventSlot) => {
  ...
  const handleAutoAssign = async () => {
    ...
    const staffPool = lightStaffOptions
    ...
    orderedSlots.forEach((slot) => {
      ...
      const op1 = pickStaff(slot, usedInSlot);
      const op2 = pickStaff(slot, usedInSlot);
      const spot = pickStaff(slot, usedInSlot);
      const assist = pickStaff(slot, usedInSlot);
