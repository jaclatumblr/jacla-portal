...
import { ArrowLeft, Music, Users, Calendar, ArrowRight } from "lucide-react"
        ...
        <section className="relative py-12 md:py-16 overflow-hidden">
          ...
          <div className="relative z-10 container mx-auto px-4 sm:px-6">
            <div className="max-w-4xl pt-12 md:pt-0">
              ...
              <p className="text-muted-foreground text-sm md:text-base">参加中のバンドとイベント状況</p>
            </div>
          </div>
        </section>
              ...
              {myBands.map((band) => (
                <div key={band.id} className="p-4 md:p-6 bg-card/50 border border-border rounded-lg">
                  ...
                  <div className="space-y-2">
                    <p className="text-xs text-muted-foreground font-medium">参加イベント</p>
                    {band.events.map((event) => (
                      ...
                      >
                        ...
                        <div className="flex items-center gap-2 shrink-0">
                          <Badge variant={event.status === "提出済み" ? "default" : "outline"} className="text-xs">
                            {event.status}
                          </Badge>
