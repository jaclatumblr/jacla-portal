...
import { ArrowLeft, CheckCircle, Clock, AlertCircle, ArrowRight } from "lucide-react"
  ...
  pending: [
    {
      ...
      type: "提出",
      urgent: true,
      link: "/events/spring-live-2025/repertoire/submit",
    },
    {
      id: 2,
      ...
      type: "確認",
      urgent: false,
      link: "/events/welcome-concert",
    },
  ],
  assigned: [{ id: 3, title: "PA機材点検（担当）", deadline: "2025-02-15", type: "担当", urgent: false, link: "/pa" }],
  completed: [{ id: 4, title: "部員情報更新", completedAt: "2025-01-10", type: "完了" }],
}
        ...
        <section className="relative py-12 md:py-16 overflow-hidden">
          ...
          <div className="relative z-10 container mx-auto px-4 sm:px-6">
            <div className="max-w-4xl pt-12 md:pt-0">
              ...
              <p className="text-muted-foreground text-sm md:text-base">未提出・担当・確認待ちのタスク一覧</p>
            </div>
          </div>
        </section>
                  ...
                  {tasks.pending.map((task) => (
                    ...
                    >
                      <div className="flex items-center gap-3 min-w-0">
                        <div
                          className={`w-2 h-2 rounded-full shrink-0 ${task.urgent ? "bg-orange-500" : "bg-primary"}`}
                        />
                  ...
                  {tasks.completed.map((task) => (
                    ...
                    >
                      <div className="flex items-center gap-3 min-w-0">
                        ...
                        <div className="min-w-0">
                          <p className="font-medium text-sm md:text-base truncate line-through">{task.title}</p>
