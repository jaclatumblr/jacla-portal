...
const announcements = [
  {
    ...
    content: "春ライブ2025のレパートリー提出締切は3月1日です。まだ提出していないバンドは早めに提出してください。",
    date: "2025-01-15",
    category: "締切",
    isPinned: true,
    isNew: true,
  ...
  },
  {
    id: 3,
    title: "PA機材メンテナンス完了",
    content: "SM58マイク5本のメンテナンスが完了しました。貸出可能になりましたので、必要な方は申請してください。",
    date: "2025-01-10",
    category: "機材",
    isPinned: false,
    isNew: false,
  },
  {
    id: 4,
    title: "練習スタジオ利用時間変更",
    content: "2月1日より練習スタジオの利用時間が変更になります。新しい利用時間は9:00〜21:00です。",
    date: "2025-01-08",
    category: "お知らせ",
    isPinned: false,
    isNew: false,
            ...
            <div className="max-w-4xl mx-auto space-y-4 md:space-y-6">
              ...
              {announcements
                ...
                .map((announcement, index) => (
                  <div
                    key={announcement.id}
                    className="group relative p-4 sm:p-6 bg-primary/5 border border-primary/20 rounded-lg hover:border-primary/50 transition-all duration-300"
                  >
              ...
              {announcements
                ...
                .map((announcement, index) => (
                  <div
                    key={announcement.id}
                    className="group relative p-4 sm:p-6 bg-card/50 border border-border rounded-lg hover:border-primary/50 transition-all duration-300"
                  >
