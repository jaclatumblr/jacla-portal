...
const equipment = [
  { id: 1, name: "LEDパーライト 64", category: "パーライト", quantity: 8, available: 6, status: "available" as const },
  { id: 2, name: "ムービングヘッド SPOT", category: "ムービング", quantity: 4, available: 2, status: "low" as const },
  { id: 3, name: "ムービングヘッド WASH", category: "ムービング", quantity: 4, available: 4, status: "available" as const },
  { id: 4, name: "ストロボライト", category: "エフェクト", quantity: 2, available: 0, status: "out" as const },
  { id: 5, name: "DMXケーブル 5m", category: "ケーブル", quantity: 12, available: 10, status: "available" as const },
  { id: 6, name: "DMXケーブル 10m", category: "ケーブル", quantity: 8, available: 6, status: "available" as const },
  { id: 7, name: "照明コントローラー", category: "コントローラー", quantity: 2, available: 1, status: "low" as const },
  { id: 8, name: "スモークマシン", category: "エフェクト", quantity: 1, available: 1, status: "available" as const },
];
