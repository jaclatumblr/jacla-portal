...
import { AlertCircle, CheckCircle, Lightbulb, NotebookPen, Sparkles } from "lucide-react";
...
const equipment: EquipmentRow[] = [
  ...
  { id: 7, name: "照明コンソール", category: "コンソール", quantity: 2, available: 1, status: "low" },
            ...
            <div className="relative z-10 container mx-auto px-4 sm:px-6">
              <div className="max-w-6xl pt-12 md:pt-0">
                ...
                <p className="text-muted-foreground text-base md:text-lg max-w-3xl">
                  照明指示・Live Adviser・機材一覧をまとめました。必要なセクションを選んで確認してください。
                </p>
            ...
            <div className="container mx-auto px-4 sm:px-6">
              <div className="grid sm:grid-cols-3 gap-4 md:gap-6 max-w-4xl mx-auto mb-8 md:mb-12">
                <div className="p-4 md:p-6 bg-card/50 border border-border rounded-lg">
                  ...
                  <p className="text-3xl md:text-4xl font-bold">38</p>
              ...
              <div className="flex items-center justify-between mb-4">
                ...
                <Button className="bg-accent text-accent-foreground hover:bg-accent/90">新規機材追加</Button>
              </div>
